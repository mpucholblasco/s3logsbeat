...
var (
	...
	S3CloudFrontWebLogParser = logparser.
		...
		WithKindMap(map[string]string{
			...
			"cs_uri_query":    "urlencoded",
			"cs_cookie":       "urlencoded",
			"time_taken":      "float64",
		}).
